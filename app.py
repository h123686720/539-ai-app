...
# --- 1. 介面樣式設定 ---
st.set_page_config(page_title="輝達科技 AI - 大數據演算終端", layout="centered")
st.markdown("""
    <style>
...
if st.session_state["step"] == "login":
    ...
    algo_steps = ["加載歷史數據...", "尾數分布演算...", "五區遺漏掃描...", "對角趨勢分析...", "跳號機率模擬...", "蒙地卡羅 10萬次模擬..."]
    ...
    st.write("---")
    st.caption("AI 模型：走勢/尾數/五區/對角線/跳號/Monte Carlo")
    if st.button("登出系統"):
